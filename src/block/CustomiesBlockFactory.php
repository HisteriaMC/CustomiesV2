...
final class CustomiesBlockFactory {
	...
	public function registerBlock(
		...
		// The "block_id" field only has to be unique and stable, so registration order is enough. Sorting the palette
		// the way the client does now happens in CustomiesListener, over the merged vanilla + custom entry list.
